 ...
 */
function upsale_customizer_get_default_link_color() {
	return '#c3251d';
}
 ...
 */
function upsale_customizer_get_default_accent_color() {
	return '#c3251d';
}
 ...
 */
function upsale_color_contrast( $color ) {
 ...
 */
function upsale_color_brightness( $color, $change ) {
